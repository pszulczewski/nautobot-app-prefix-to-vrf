...
- `project_name`: the default docker compose project name (default: `prefix-to-vrf`)
...
#14 naming to docker.io/prefix-to-vrf/nautobot:2.1.0-py3.11 done
```
...
Creating network "prefix_to_vrf_default" with the default driver
Creating volume "prefix_to_vrf_postgres_data" with default driver
Creating prefix_to_vrf_redis_1 ...
Creating prefix_to_vrf_docs_1  ...
Creating prefix_to_vrf_postgres_1 ...
Creating prefix_to_vrf_postgres_1 ... done
Creating prefix_to_vrf_redis_1    ... done
Creating prefix_to_vrf_nautobot_1 ...
Creating prefix_to_vrf_docs_1     ... done
Creating prefix_to_vrf_nautobot_1 ... done
Creating prefix_to_vrf_worker_1   ...
Creating prefix_to_vrf_worker_1   ... done
...
ee90fbfabd77   prefix-to-vrf/nautobot:2.1.0-py3.11  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               prefix_to_vrf_worker_1
b8adb781d013   prefix-to-vrf/nautobot:2.1.0-py3.11  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   prefix_to_vrf_nautobot_1
d64ebd60675d   prefix-to-vrf/nautobot:2.1.0-py3.11  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   prefix_to_vrf_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   prefix_to_vrf_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   prefix_to_vrf_redis_1
```
...
Stopping prefix_to_vrf_worker_1   ...
Stopping prefix_to_vrf_nautobot_1 ...
Stopping prefix_to_vrf_docs_1     ...
Stopping prefix_to_vrf_redis_1    ...
Stopping prefix_to_vrf_postgres_1 ...
Stopping prefix_to_vrf_worker_1   ... done
Stopping prefix_to_vrf_nautobot_1 ... done
Stopping prefix_to_vrf_postgres_1 ... done
Stopping prefix_to_vrf_redis_1    ... done
Stopping prefix_to_vrf_docs_1     ... done
Removing prefix_to_vrf_worker_1   ...
Removing prefix_to_vrf_nautobot_1 ...
Removing prefix_to_vrf_docs_1     ...
Removing prefix_to_vrf_redis_1    ...
Removing prefix_to_vrf_postgres_1 ...
Removing prefix_to_vrf_postgres_1 ... done
Removing prefix_to_vrf_docs_1     ... done
Removing prefix_to_vrf_worker_1   ... done
Removing prefix_to_vrf_redis_1    ... done
Removing prefix_to_vrf_nautobot_1 ... done
Removing network prefix_to_vrf_default
```
...
So for example, our app is named `prefix-to-vrf`, the command would most likely be `docker logs prefix_to_vrf_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("prefix_to_vrf")
namespace.configure(
    {
        "prefix_to_vrf": {
            ...
...
Or set the `INVOKE_PREFIX_TO_VRF_PYTHON_VER` variable.
...
Or set the `INVOKE_PREFIX_TO_VRF_NAUTOBOT_VER` variable.
...
In the package source, there is the `prefix_to_vrf/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
